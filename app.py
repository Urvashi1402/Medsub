...
image = Image.open('images/MedSub (2).png')
st.image(image, caption='Medicine Substitute Recomendation System by Urvashi & Rishita')
...
st.title('Medicine Substitute Recommender')

                                        # Searchbox
selected_medicine_name = st.selectbox(
'Type the name of medicine whose substitue is to be recomended',
...
image = Image.open('images/footer.png')
st.image(image, caption='Medicine Substitute Recommendation System by Urvashi & Rishita')
